...
struct AboutView: View {
    ...
    var body: some View {
        SettingsPage {
            ...
            SettingsFootnote(String(localized: "Amgi uses the official Anki Rust backend. The backend code is licensed under AGPL-3.0 and remains the work of its authors."))
        }
